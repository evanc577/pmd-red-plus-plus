...
bool8 CreateOthersDisplayScreen(GameOptions *optionsMenu)
{
    ...
    sUnknown_203B260->unk48 = &sUnknown_203B260->window_templates.id[0];
    RestoreSavedWindows(&sUnknown_203B260->window_templates);
    sUnknown_203B260->window_templates.id[sUnknown_203B260->unk44] = sUnknown_80DC03C;
    sub_8012D08(sUnknown_203B260->unk48, 1);
    ResetUnusedInputStruct();
    ShowWindows(&sUnknown_203B260->window_templates, TRUE, TRUE);
...
void sub_801E2C4(void)
{
    if (sUnknown_203B260 != NULL) {
        sUnknown_203B260->window_templates.id[sUnknown_203B260->unk44] = sUnknown_80DC020;
        ResetUnusedInputStruct();
        ShowWindows(&sUnknown_203B260->window_templates, TRUE, TRUE);
